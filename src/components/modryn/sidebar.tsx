        ...
        <nav className="border-sidebar-border bg-sidebar-rail flex w-18 flex-col items-center border-r">
          ...
          <div className="mt-auto flex w-full flex-col items-center px-2 pb-4">
            <button
              ...
              className="text-sidebar-muted hover:bg-sidebar-accent/45 hover:text-sidebar-foreground flex w-full flex-col items-center justify-center gap-1 rounded-sm border border-transparent py-1.5 transition-colors hover:border-white/5"
              title="Sign out"
            >
